          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Map Your <span className="text-[#2E7D32]">Eco</span>system
                Through <span className="text-[#1565C0]">Citizen Science</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Join thousands of nature enthusiasts in documenting biodiversity
                around you. Spot species, contribute data, and help create
          ...
          <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="relative z-10 bg-neutral-100 p-6 rounded-lg shadow-lg">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <p className="text-gray-600 text-sm">Active Citizens</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <p className="text-gray-600 text-sm">Species Tracked</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <h3 className="font-bold text-xl">{countData.data.occurrence || "-"}</h3>
                      <p className="text-gray-600 text-sm">Animals Spotted</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      <div className="text-[#2E7D32] mb-2">
                      <svg
                      ...
                      <h3 className="font-bold text-xl">{countData.data.expert || "-"}</h3>
            ...
            >
              ...
              <div className="space-y-6 text-neutral-600">
                <p className="text-lg">
                  EcoMap is a crowd-sourced platform that harnesses the power of
                  community observations to track and monitor biodiversity
                  across the globe.
                </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p>
                      Anyone can contribute valuable ecological data through
                      simple species sightings - from casual nature enthusiasts
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p>
                      Specialized experts help identify species from photos,
                      making scientific contribution accessible to everyone
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p>
                      Collected data creates detailed density maps showing
                      biodiversity hotspots, migration patterns, and species
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
              Our platform makes it easy for anyone to contribute to
              environmental science and conservation. Follow these simple steps
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-neutral-600 mb-4">
                When you encounter wildlife or interesting plant species, use
                the EcoMap app to take a photo. Our system works with any
                quality of photo, from smartphone snapshots to professional
                cameras.
              </p>
            ...
            >
              ...
              <p className="text-neutral-600 mb-4">
                Experts analyze your photo and correctly identify the species
                for you.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-neutral-600 mb-4">
                Your contributions are immediately added to our global database,
                creating real-time density maps that track biodiversity hotspots
                and help identify trends in species distribution.
              </p>
              <ul className="text-sm text-neutral-500 space-y-2">
                <li className="flex items-start">
                  <svg
          ...
          >
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/2 bg-neutral-900 p-8 flex items-center justify-center">
                <div className="relative w-full max-w-md aspect-video bg-neutral-800 rounded-lg overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button
                      className="w-16 h-16 bg-[#2E7D32]/80 hover:bg-[#2E7D32] rounded-full flex items-center justify-center transition-colors duration-300"
                  ...
                  <div className="absolute bottom-3 left-3 bg-neutral-900/70 px-3 py-1 rounded text-white text-xs">
                    1:24
                  </div>
                </div>
              </div>
              ...
              <div className="md:w-1/2 p-8 md:p-12">
                <h3 className="text-2xl font-bold mb-4 text-neutral-800">
                  See EcoMap in Action
                </h3>
                <p className="text-neutral-600 mb-6">
                  Watch our quick demonstration video to see how easy it is to
                  spot, identify, and contribute to biodiversity mapping. Join
                  thousands of citizen scientists making a difference.
                </p>

                <div className="space-y-4">
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-[#2E7D32]/10 flex items-center justify-center mr-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-[#FF8F00]/10 flex items-center justify-center mr-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 text-[#FF8F00]"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-600">
                        Expert verification and guidance
                      </p>
                    </div>
                  </div>
                </div>
